  ...
  return (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex justify-center items-center">
        ...
        <div className="flex justify-end gap-x-3 mt-5">
            ...
            <button onClick={updateProduct} className="px-4 py-2 border border-transparent rounded-md text-white bg-blue-600 hover:bg-blue-700">Actualizar producto</button>
        </div>
       </div>
      </div>
    </div>
