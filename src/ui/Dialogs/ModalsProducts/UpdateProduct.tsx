      ...
      <div className="bg-[#ddd] overflow-y-auto text-gray-700 dark:text-gray-300 dark:bg-[#1f1f1f] rounded-md min-h-52 xs:max-h-[590px] max-h-[670px] w-full max-w-xl p-4 scrollbar-custom">
        <div className="h-full">
          ...
          <div className="flex flex-col gap-y-3">
            ...
            <div className="flex items-center gap-x-2 my-2">
              <input
                ...
                type="checkbox"
              />
              <label className="text-sm font-medium" htmlFor="offer">
                ¿Esta en oferta?
              </label>
            ...
            {/* {categories.length > 0 && (
              <div>
                ...
                >
                  {categories.map((category) => (
                    <option
                      key={category.id}
                      value={category.id}
                      className="font-medium dark:text-gray-200 checked:bg-[#ccc] dark:checked:bg-[#444] checked:rounded-md p-0.5 my-0.5"
                    >
                ...
                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  Mantenga presionado Ctrl (Windows) o Cmd (Mac) para
          ...
          <div className="flex justify-end gap-x-3 mt-5">
            <button
              onClick={onClose}
              className="px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-600 dark:hover:bg-red-600/90 "
            >
              Cancelar
            </button>
            <button
